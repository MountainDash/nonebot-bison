...
def embed_image_as_data_url(image_path: Path) -> str:
...
class CeobeCanteenTheme(Theme):
    ...
    async def render(self, post: "Post") -> list[MessageSegmentFactory]:
        ...
        # 获取嵌入的图片数据
        bison_logo_data = embed_image_as_data_url(self.template_path / "bison_logo.png")
        ceobe_logo_data = embed_image_as_data_url(self.template_path / "ceobecanteen_logo.png")
