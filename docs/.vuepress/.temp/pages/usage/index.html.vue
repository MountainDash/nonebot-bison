...
<ul>
<li>
<p><code>BISON_CONFIG_PATH</code>: 插件存放配置文件的位置，如果不设定默认为项目目录下的<code>data</code>目录</p>
</li>
<li>
<p><code>BISON_USE_PIC</code>: 将文字渲染成图片后进行发送，多用于规避风控</p>
</li>
<li>
<p><code>BISON_BROWSER</code>: 本插件使用 Chrome 来渲染图片</p>
<ul>
...
<li>
<p><code>BISON_SKIP_BROWSER_CHECK</code>: 是否在启动时自动下载浏览器，如果选择<code>False</code>会在用到浏览器时自动下载，
默认<code>True</code></p>
</li>
<li>
<p><code>BISON_OUTER_URL</code>: 从外部访问服务器的地址，默认为<code>http://localhost:8080/bison</code>，如果你的插件部署
在服务器上，建议配置为<code>http://&lt;你的服务器ip&gt;:8080/bison</code></p>
</li>
<li>
<p><code>BISON_FILTER_LOG</code>: 是否过滤来自<code>nonebot</code>的 warning 级以下的 log，如果你的 bot 只运行了这个插件可以考虑
开启，默认关</p>
</li>
<li>
<p><code>BISON_USE_QUEUE</code>: 是否用队列的方式发送消息，降低发送频率，默认开</p>
</li>
<li>
<p><code>BISON_RESEND_TIMES</code>: 最大重发次数，默认 0</p>
</li>
<li>
<p><code>BISON_USE_PIC_MERGE</code>: 是否启用多图片时合并转发（仅限群）</p>
<ul>
<li><code>0</code>: 不启用(默认)</li>
<li><code>1</code>: 首条消息单独发送，剩余图片合并转发</li>
<li><code>2</code>: 所有消息全部合并转发</li>
</ul>
<details class="custom-container details"><summary>配置项示例</summary>
<ul>
...
<div class="custom-container warning"><p class="custom-container-title">WARNING</p>
<p>本节假设<code>COMMAND_START</code>设置中包含<code>''</code></p>
<ul>
<li>如果出现 bot 不响应的问题，请先排查这个设置</li>
<li>尝试在命令前添加设置的命令前缀，如<code>COMMAND_START=['/']</code>，则尝试使用<code>/添加订阅</code></li>
</ul>
</div>
