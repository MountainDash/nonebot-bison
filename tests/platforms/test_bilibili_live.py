...
async def test_fetch_bililive_no_room(bili_live, dummy_only_open_user_subinfo):
    ...
    target = "13164144"
    res = await bili_live.batch_fetch_new_post([(target, [dummy_only_open_user_subinfo])])
...
async def test_fetch_first_live(bili_live, dummy_only_open_user_subinfo):
    ...
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res2 = await bili_live.batch_fetch_new_post([(target, [dummy_only_open_user_subinfo])])
...
async def test_fetch_bililive_only_live_open(bili_live, dummy_only_open_user_subinfo):
    ...
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res3 = await bili_live.batch_fetch_new_post([(target, [dummy_only_open_user_subinfo])])
    assert bili_live_router.call_count == 3
    assert len(res3[0][1]) == 0
    # 直播状态更新-下播
    mock_bili_live_status["data"][target]["live_status"] = 0
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res4 = await bili_live.batch_fetch_new_post([(target, [dummy_only_open_user_subinfo])])
...
async def test_fetch_bililive_only_title_change(bili_live, dummy_only_title_user_subinfo):
    ...
    res = await bili_live.batch_fetch_new_post([(target, [dummy_only_title_user_subinfo])])
    assert bili_live_router.call_count == 1
    assert len(res) == 0
    # 未开播前标题变更
    mock_bili_live_status["data"][target]["title"] = "【Zc】从0挑战到15肉鸽！目前11难度"
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res0 = await bili_live.batch_fetch_new_post([(target, [dummy_only_title_user_subinfo])])
    assert bili_live_router.call_count == 2
    assert len(res0) == 0
    # 直播状态更新-上播
    mock_bili_live_status["data"][target]["live_status"] = 1
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res2 = await bili_live.batch_fetch_new_post([(target, [dummy_only_title_user_subinfo])])
    assert bili_live_router.call_count == 3
    assert len(res2[0][1]) == 0
    # 标题变更
    mock_bili_live_status["data"][target]["title"] = "【Zc】从0挑战到15肉鸽！目前12难度"
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res3 = await bili_live.batch_fetch_new_post([(target, [dummy_only_title_user_subinfo])])
    post = res3[0][1][0]
    assert post.target_type == "Bilibili直播"
    ...
    mock_bili_live_status["data"][target]["live_status"] = 0
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res4 = await bili_live.batch_fetch_new_post([(target, [dummy_only_title_user_subinfo])])
...
async def test_fetch_bililive_only_close(bili_live, dummy_only_close_user_subinfo):
    ...
    res = await bili_live.batch_fetch_new_post([(target, [dummy_only_close_user_subinfo])])
    assert bili_live_router.call_count == 1
    assert len(res) == 0
    # 未开播前标题变更
    mock_bili_live_status["data"][target]["title"] = "【Zc】从0挑战到15肉鸽！目前11难度"
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res0 = await bili_live.batch_fetch_new_post([(target, [dummy_only_close_user_subinfo])])
    assert bili_live_router.call_count == 2
    assert len(res0) == 0
    # 直播状态更新-上播
    mock_bili_live_status["data"][target]["live_status"] = 1
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res2 = await bili_live.batch_fetch_new_post([(target, [dummy_only_close_user_subinfo])])
    assert bili_live_router.call_count == 3
    assert len(res2[0][1]) == 0
    # 标题变更
    mock_bili_live_status["data"][target]["title"] = "【Zc】从0挑战到15肉鸽！目前12难度"
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res3 = await bili_live.batch_fetch_new_post([(target, [dummy_only_close_user_subinfo])])
    assert bili_live_router.call_count == 4
    assert len(res3[0][1]) == 0
    # 直播状态更新-下播
    mock_bili_live_status["data"][target]["live_status"] = 0
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res4 = await bili_live.batch_fetch_new_post([(target, [dummy_only_close_user_subinfo])])
    assert bili_live_router.call_count == 5
    post = res4[0][1][0]
    assert post.target_type == "Bilibili直播"
...
async def test_fetch_bililive_combo(bili_live, dummy_bililive_user_subinfo):
    ...
    res = await bili_live.batch_fetch_new_post([(target, [dummy_bililive_user_subinfo])])
    assert bili_live_router.call_count == 1
    assert len(res) == 0
    # 未开播前标题变更
    mock_bili_live_status["data"][target]["title"] = "【Zc】从0挑战到15肉鸽！目前11难度"
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res0 = await bili_live.batch_fetch_new_post([(target, [dummy_bililive_user_subinfo])])
    assert bili_live_router.call_count == 2
    assert len(res0) == 0
    # 直播状态更新-上播
    mock_bili_live_status["data"][target]["live_status"] = 1
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res2 = await bili_live.batch_fetch_new_post([(target, [dummy_bililive_user_subinfo])])
    post2 = res2[0][1][0]
    ...
    mock_bili_live_status["data"][target]["title"] = "【Zc】从0挑战到15肉鸽！目前12难度"
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res3 = await bili_live.batch_fetch_new_post([(target, [dummy_bililive_user_subinfo])])
    post3 = res3[0][1][0]
    ...
    mock_bili_live_status["data"][target]["live_status"] = 0
    bili_live_router.mock(return_value=Response(200, json=mock_bili_live_status))
    res4 = await bili_live.batch_fetch_new_post([(target, [dummy_bililive_user_subinfo])])
    post4 = res4[0][1][0]
